...
const DocumentListPage = () => {
  ...
  const handleUpload = async (e) => {
    ...
    if (!uploadFile || !uploadTitle) {
      toast.error("Please Provide a Title & Select a File");
      return;
    }
    setUploading(true);
      ...
      return (
        <div className="flex items-center justify-center min-h-[400px] ">
          <div className="text-center max-w-md">
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-linear-to-br from-slate-100 to-slate-100 shadow-lg shadow-slate-200/50 mb-6">
              <FileTextIcon
  ...
  return (
    <div className="min-h-screen">
      ...
      {isUploadModelOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blue-sm">
     ...
     {isDeleteModalOpen && (<div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blue-sm ">
        <div className="relative w-full max-w-md bg-white/95 backdrop-blue-xl border border-slate-200/60 rounded-2xl shadow-2xl shadow-slate-900/20 p-8 ">
          ...
          <div className="mb-6">
            <div className="w-12 h-12 rounded-xl bg-linear-to-r from-red-100 to-red-200 flex items-center justify-center mb-4">
              <Trash2Icon className="w-6 h-6 text-red-600" strokeWidth={2} />
            </div>
            <h2 className="text-xl font-medium text-slate-900 tracking-tight">
              Confirm Deletion
            </h2>
