  ...
  return (
    <>
      <div className="min-h-screen">
        <div className="absolute inset-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] bg-size-[16px_16px] opacity-300 pointer-event-none " />
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <div className="mb-6">
            ...
            <p className="text-slate-500 text-sm">
              Tracking your learning progress and activity
            </p>
          </div>
            ...
            {stats.map((stat, index) => (
              <div
                ...
                className="group relative bg-white/80 backdrop-blur-xl border border-slate-200/60 
                  rounded-2xl shadow-xl shadow-slate-200/50 p-6 
                  transition-all duration-300 ease-out
                  hover:shadow-2xl hover:shadow-slate-300/50  hover:scale-105"
              >
                <div className="flex items-center justify-between">
                  ...
                  <div
                    className={`w-11 h-11 rounded-xl bg-linear-to-br
                      ${stat.gradient} shadow-lg ${stat.shadowColor} flex items-center justify-center group-hover:scale-110
          ...
          <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-xl bg-linear-to-br from-slate-100 to-slate-200 flex items-center justify-center">
                <ClockIcon className="w-5 h-5 text-slate-600" strokeWidth={2} />
              </div>
