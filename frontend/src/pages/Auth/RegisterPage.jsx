          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full h-12 pl-12 pr-4 border-2 border-slate-300 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10 "
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                >
                  <LockIcon className="h-5 w-5" strokeWidth={2} />
                </div>
                <input
                ...
                {password && (
                  ...
                  text-slate-400 hover:text-emerald-500 transition-colors duration-200"
                  >
                    {showPassword ? (
            ...
            >
              ...
              <div
                className="absolute inset-0 bg-linear-to-r from-white/0 via-white/20 to-white/0 -translate-x-full
