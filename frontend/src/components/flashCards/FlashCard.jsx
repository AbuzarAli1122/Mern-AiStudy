...
import { Star as StarIcon, RotateCcw as RotateCcwIcon } from "lucide-react";
      ...
      >
        ...
        >
          ...
          <div className="flex items-start justify-between">
            ...
            >
              <StarIcon
                className="w-4 h-4"
                strokeWidth={2}
                fill={flashcard.isStarred ? "currentColor" : "nonr"}
              />
            </button>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 text-xs text-slate-400 font-medium">
            <RotateCcwIcon className="w-3.5 h-3.5 " strokeWidth={2} />
        ...
        >
          ...
          <div className="flex  items-center justify-center gap-2 text-xs text-white/70 font-medium ">
            <RotateCcwIcon className="w-3.5 h-3.5" strokeWidth={2} />
            <span>Click me to see question</span>
          </div>
        </div>
      </div>
    </div>
