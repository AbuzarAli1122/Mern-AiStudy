...
const ChatInterface = () => {
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      const errorMessage = {
        role: "assistant",
        content: "Sorry, I encounter an error. Please try again.",
        timestamp: new Date(),
      };
      ...
      >
        {!isUser && (
          <div className="w-9 h-9 rounded-xl bg-linear-to-br from-emerald-400 to-teal-500 shadow-lg shadow-emerald-500/25 flex items-center justify-center shrink-0 ">
            <SparklesIcon className="w-4 h-4 text-white" strokeWidth={2} />
          </div>
        )}
        <div
